...
**If you expect developers to request API keys with email and possibly wait days or weeks, you must have some sort of a deadwish.**

<img itemprop="image" src="{{site.baseurl}}/assets/img/day8/survey.png" alt="{{site.name}}">

On top of that getting started is valued high. You need to provide fast first positive experience with your API. Profound documentation with all the details clearly stated is expected but great documentation contains also getting started section. 
